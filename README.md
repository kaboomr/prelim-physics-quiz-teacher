...
| `IND21_q*.png`, `P22_q*.png`/`.svg`, `JR20_q*.png`, `PYM24_q*.png`/`.svg`, `P23_q*.png`/`.svg` | Short-answer question images (must match the student game) |

**On the question bank:** `data-sa.js` holds 80 Section II sub-questions from five real
papers (2021 NSW Independent Trial Exams, 2022 NSW Independent Exams, James Ruse's 2020
Physics Year 11 Yearly Exam, Pymble Ladies' College's 2024 Physics Year 11 Examination, and
2023 NSW Independent Exams), with official marking criteria and sample answers —
